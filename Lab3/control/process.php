...
$fnameerr=$lnameerr=$ageerr=$passerr=$deserr=$plerr=$emailerr=$pl1=$pl2=$pl3=$fileerr=$dataerr="";
$count=0;
...
if(move_uploaded_file($_FILES["myfile"]["tmp_name"], "../upload/".$fname.date("Y-m-d").".jpg")){
    $count++;
